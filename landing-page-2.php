      ...
      <div class="row v-center">
        <div class="col-lg-7">
          <div class="header-headings">
            ...
            <h1 class="wow fadeIn mt20 mb30" data-wow-delay=".4s">
              The most straightforward payment solution for your company's
              requirements
            </h1>
...
<section class="dg-service2 pad-tb" id="services">
  <div class="container">
    ...
    <div class="row justify-content-center">
      <div
        class="col-lg-3 col-sm-6 mt30 wow fadeIn niwax"
        data-wow-delay=".2s"
        data-rellax-speed=".5"
      ...
      >
        <div class="s-block text-l hoverwithbg up-hor animation">
          <div class="nx-circl-icon nxlp-a">
            <img src="images/icons/integration.png" alt="icon" />
          </div>
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="common-heading text-l">
          ...
          <h2 class="mb20">
            Since 2000, We've Been the Most Dependable Web Design Company.
          </h2>
          <p>
            We have produced IT solutions at a worldwide level by using the full
            potential of the latest disruptive technologies as one of the
            leading IT consulting companies in India. We have produced IT
            solutions at a worldwide level by using the full potential of the
            latest disruptive technologies as one of the leading IT consulting
            companies in India.
          </p>
          <p>
            We have produced IT solutions at a worldwide level by using the full
            potential of the latest disruptive technologies as one of the
            leading IT consulting companies in India.
          </p>
        </div>
      </div>
      <div class="col-lg-6">
        ...
        <div class="niwaxwideserviceslider owl-carousel center-dots">
          <div class="sliderset-nx">
            <div class="service-we-deliverd">
              ...
              <p class="mt20">
                We have been providing Digital Marketing service from last 8
                years by direct collaboration with our clients. As a Digital
                Marketing company we are providing all services like SEO Audit,
                Pay Per Click, Social Media Management, Organic SEO.
              </p>
              <a href="#" class="niwax-btn2 mt40">More Details</a>
            </div>
            <div class="imagesofservice">
              <img
                src="images/service/payment-service-1.svg"
                alt="niwax landing page 2"
                class="img-fluid"
              />
            </div>
          </div>
          ...
          <div class="sliderset-nx">
            ...
            <div class="imagesofservice">
              <img
                src="images/service/payment-service-2.svg"
                alt="niwax landing page 2"
                class="img-fluid"
              />
            </div>
          ...
          <div class="sliderset-nx">
            ...
            <div class="imagesofservice">
              <img
                src="images/service/payment-service-3.svg"
                alt="niwax landing page 2"
                class="img-fluid"
              />
            </div>
          ...
          <div class="sliderset-nx">
            ...
            <div class="imagesofservice">
              <img
                src="images/service/payment-service-4.svg"
                alt="niwax landing page 2"
                class="img-fluid"
              />
            </div>
      ...
      <div class="col-lg-12">
        <div class="whychooseniwax v-center">
          ...
          <div class="niwaxawardrow2">
            <h2>
              Why Should You
              <span class="text-radius text-light text-animation bg-b"
                >Choose Us!</span
              >
            </h2>
            <h4 class="mt10 text-second">Find your reasons to choose us</h4>
            <p class="mt20">
              We have been providing Digital Marketing service from last 8 years
              by direct collaboration with our clients. As a Digital Marketing
              company we are providing all services like SEO Audit, Pay Per
              Click, Social Media Management, Organic SEO.
            </p>
            <p class="mt10">
              We work with organizations of all sizes, from startups to Fortune
              companies. We believe in forging long-lasting partnerships with
              all of our clients and we remain available to our clients whenever
              they need us. Contact us for more information.
            </p>
          ...
          <div class="reviews-card pr-shadow">
            <div class="row v-center">
              ...
              <div class="col">
                <span class="revbx-rl"
                  ><img
                    src="images/client/upwork-logo.png"
      ...
      <div class="col-lg-8">
        <div class="common-heading ptag">
          ...
          <p class="mb30">
            ...
            competitively. We offer comprehensive yet cost-effective options.
            Everyone will find enticing features in our Basic, Professional, and
            Premium packages.
          </p>
        </div>
      </div>
    ...
    <div class="row justify-content-center">
        ...
        <div class="niwaxpricingbox shadow">
          ...
          <div class="priceodernow">
            <div class="priceoderbtn">
              <a href="#" class="niwax-btn3">Order Now</a>
            </div>
      ...
      <div class="col-lg-4 col-md-6 nxpb-2">
        <div class="niwaxpricingbox shadow reco">
          ...
          <div class="priceodernow">
            <div class="priceoderbtn">
              <a href="#" class="niwax-btn2">Order Now</a>
            </div>
            <div class="priceaskwithus">
              <a href="#" class="livechatbtn d-flex gap10 v-center">
                <i class="fas fa-comment"></i>
  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".2s">
        <div class="s-block wide-sblock">
          <div class="s-card-icon">
            <img src="images/icons/teama.svg" alt="service" class="img-fluid" />
          </div>
      ...
      <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".5s">
        <div class="s-block wide-sblock">
          <div class="s-card-icon">
            <img src="images/icons/link.svg" alt="service" class="img-fluid" />
          </div>
          <div class="s-block-content">
      ...
      <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".8s">
        <div class="s-block wide-sblock">
          <div class="s-card-icon">
            <img src="images/icons/tech.svg" alt="service" class="img-fluid" />
          </div>
          <div class="s-block-content">
      ...
      <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.1s">
        <div class="s-block wide-sblock">
          <div class="s-card-icon">
            <img src="images/icons/hi.svg" alt="service" class="img-fluid" />
          </div>
          <div class="s-block-content">
      ...
      <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.4s">
        <div class="s-block wide-sblock">
          <div class="s-card-icon">
            <img src="images/icons/badge.svg" alt="service" class="img-fluid" />
          </div>
          <div class="s-block-content">
      ...
      <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.7s">
        <div class="s-block wide-sblock">
          <div class="s-card-icon">
            <img src="images/icons/tin.svg" alt="service" class="img-fluid" />
          </div>
          <div class="s-block-content">
