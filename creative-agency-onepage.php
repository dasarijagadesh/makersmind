...
<!--Start Hero-->
<section
  class="hero-section hero-creative-agenc1"
  data-background="images/banner/hero-creative-agenc1.jpg"
  id="home"
>
      ...
      <div class="row">
        <div class="col-lg-7 v-center niwax" data-rellax-speed="-3">
          <div class="header-heading">
            ...
            <a
              href="#"
              class="btn-main bg-btn6 lnk wow fadeInUp"
              data-wow-delay=".6s"
