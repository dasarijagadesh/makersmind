...
<!--End Header -->
<!--Start Hero-->
<section class="hero-section hero-creative-agenc1" data-background="images/banner/hero-creative-agenc1.jpg">
    <div class="text-block">
        <div class="container">
            <div class="row">
                <div class="col-lg-7 v-center niwax" data-rellax-speed="-3">
                    <div class="header-heading">
                        <h1 class="wow fadeInUp text-effect-2" data-wow-delay=".2s">
                            We believe in the power of creativity to solve problems.
                        </h1>
                        <p class="wow fadeInUp" data-wow-delay=".4s">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                            Suspendisse faucibus, risus sit amet auctor sodales, justo erat
                            tempor eros.
                        </p>
                        <a href="#" class="btn-main bg-btn6 lnk wow fadeInUp" data-wow-delay=".6s">GET STARTED<i
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="common-heading-2 text-center">
                    <span class="text-effect-2">Populor Services</span>
        ...
        <div class="row upset ovr-bg2 ho-gdnt">
                ...
                <div class="s-block up-hor ovr-base">
                    <div class="nn-card-set">
                        <div class="s-card-icon">
                            <img src="images/icons/branding.svg" alt="service" class="img-fluid" />
                        </div>
            ...
            <div class="col-lg-4 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".4s">
                <div class="s-block up-hor ovr-base">
                    <div class="nn-card-set">
                        <div class="s-card-icon">
                            <img src="images/icons/development.svg" alt="service" class="img-fluid" />
                        </div>
            ...
            <div class="col-lg-4 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".6s">
                <div class="s-block up-hor ovr-base">
                    <div class="nn-card-set">
                        <div class="s-card-icon">
                            <img src="images/icons/app.svg" alt="service" class="img-fluid" />
                        </div>
            ...
            <div class="col-lg-4 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".8s">
                <div class="s-block up-hor ovr-base">
                    <div class="nn-card-set">
                        <div class="s-card-icon">
                            <img src="images/icons/marketing.svg" alt="service" class="img-fluid" />
                        </div>
            ...
            <div class="-cta-btn mt70">
                <div class="free-cta-title v-center wow zoomInDown" data-wow-delay="1s">
                    ...
                    <a href="#" class="btn-main bg-btn6 lnk">
                        Request a proposal<i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
                </div>
            </div>
        </div>
    </div>
...
<!--End Service-->
<!--Start About-->
<section class="about-dg- dg-bg--2 sec-dark pb130 pt130">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="common-heading-2 text-l">
                    <span class="text-effect-2">We Are Creative Agency</span>
            ...
            <div class="col-lg-6 v-center h-scl-">
                <div class="img-block hover-scale h-scl-base">
                    ...
                    <div class="shape-dg-1 dg-hero-shp1">
                        <img src="images/shape/dots-dg.png" alt="shape" class="img-fluid" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="common-heading-2">
                    <span class="text-effect-2">Our Work</span>
            ...
            <div class="col-lg-6">
                <div class="owl-carousel testimonial-card-a pl25">
                    <div class="testimonial-card">
                        ...
                        <div class="link-reviewrr">
                            <a href="#">Read Project Case Study
            ...
            <div class="col-lg-4 mt30">
                <div class="single-blog-post- up-hor shdo">
                    ...
                    <div class="blog-content-tt">
                        <div class="single-blog-info-">
                            <h4>
                                <a href="#">Exploring the Key Features of Laravel 7 Framework</a>
                            </h4>
                            <p>
                                Lorem Ipsum is simply dummy text of the printing and typesetting
                                industry.
            ...
            <div class="col-lg-4 mt30">
                <div class="single-blog-post- up-hor shdo">
                    ...
                    <div class="blog-content-tt">
                        <div class="single-blog-info-">
                            <h4>
                                <a href="#">Best Technology for Mobile Application Development</a>
                            </h4>
                            <p>
                                Lorem Ipsum is simply dummy text of the printing and typesetting
                                industry.
...
<!--End CTA-->
<!--Start Clients-->
<section class="dg-clients-section bg-flat1 pb120 pt120">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="common-heading-2">
        ...
        <div class="-cta-btn mt80">
            <div class="free-cta-title v-center wow zoomInDown" data-wow-delay="1.2s">
                ...
                <a href="#" class="btn-main bg-btn6 lnk">Request a proposal<i
                        class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-5 v-center">
                <div class="email-subs-form">
                    <div class="form-cta">
                        ...
                        <button type="submit" name="submit" class="lnk btn-main bg-btn6">
                            Subscribe <i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span>
                        </button>
                    </div>
                </div>
            </div>
