            ...
            <div class="col-lg-6 v-center h-scl-">
                <div class="img-block-ca2 text-center h-scl-base m-mt30">
                    ...
                    <div class="shape-dg-1 dg-hero-shp1">
                        <img src="images/shape/dots-dg.png" alt="shape" class="img-fluid dot-sp-ca2" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row upset ovr-bg2 bd-hor">
            ...
            <div class="-cta-btn mt70">
                <div class="free-cta-title v-center wow zoomInDown" data-wow-delay="1s">
                    ...
                    <a href="#" class="btn-main bg-btn7 lnk">
        ...
        <div class="row mt60">
            <div class="col-lg-12 col-sm-12">
                <div class="porto-slide owl-carousel">
                    ...
                    <div class="div-portfolio- row no-gutters">
                        <div class="div-item-image col-lg-6 text-center v-center">
                            <a href="#"><img src="images/portfolio/image-2.jpg" alt="portfolio" class="img-fluid" />
                            </a>
                        </div>
                        <div class="div-item-info col-lg-6 v-center">
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="image-block upset h-scl-">
                        <div class="image-div h-scl-base">
                            <img src="images/team/team-single.jpg" alt="team" class="img-fluid" />
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-lg-5 mt30 h-scl-">
                <div class="img-ca2set h-scl-base">
                    <img src="images/about/office-1.jpg" alt="companyname" class="img-fluid" />
                </div>
            </div>
            <div class="col-lg-7 mt30 h-scl-">
                <div class="img-ca2set h-scl-base">
                    <img src="images/about/office-2.jpg" alt="companyname" class="img-fluid" />
                </div>
            </div>
            <div class="col-lg-7 mt30 h-scl-">
                <div class="img-ca2set h-scl-base">
                    <img src="images/about/office-3.jpg" alt="companyname" class="img-fluid" />
                </div>
            </div>
            <div class="col-lg-5 mt30 h-scl-">
                <div class="img-ca2set h-scl-base">
                    <img src="images/about/office-4.jpg" alt="companyname" class="img-fluid" />
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-5 v-center">
                <div class="email-subs-form">
                    <div class="form-cta">
                        ...
                        <button type="submit" name="submit" class="lnk btn-main bg-btn7">
