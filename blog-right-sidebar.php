          ...
          <div class="recent-post widgets mt60">
            ...
            <div class="blog-categories">
              <ul>
                <li>
                  <a href="#"
                    >Business <span class="categories-number">(2)</span></a
                  >
                </li>
                <li>
                  <a href="#"
                    >Financial <span class="categories-number">(3)</span></a
                  >
                </li>
                <li>
                  <a href="#"
                    >Uncategorized <span class="categories-number">(4)</span></a
                  >
                </li>
                <li>
                  <a href="#"
                    >Web Design <span class="categories-number">(3)</span></a
                  >
                </li>
                <li>
                  <a href="#"
                    >WordPress <span class="categories-number">(5)</span></a
                  >
                </li>
              </ul>
            </div>
