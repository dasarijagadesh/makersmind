...
<!--End Header -->
<!--Start Hero-->
<section class="hero-section hero-bg-bg1 bg-gradient web-deg" id="home">
            ...
            <div class="row">
                <div class="col-lg-6 v-center">
                    <div class="header-heading">
                        ...
                        <a href="#contact" class="btn-main bg-btn lnk wow fadeInUp" data-wow-delay=".6s">Get A Free
                            Quote <i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
                    </div>
                </div>
                <div class="col-lg-6 v-center">
                    ...
                    <div class="user- mt30">
                        <div class="media">
                            <div class="user-image bdr-radius">
                                <img src="images/user-thumb/girl2.jpg" alt="girl" class="img-fluid" />
                            </div>
