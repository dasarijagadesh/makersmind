                    ...
                    <div class="bread-inner">
                        ...
                        <div class="bread-title">
                            ...
                            <div class="btn-grp mt40">
                                <a href="#" class="btn-main bg-btn lnk">Live Preview <i class="fas fa-share"></i>
                                    <span class="circle"></span></a>
                                <a href="#" class="btn-main bg-btn3 lnk">Buy Now <i class="fas fa-shopping-cart"></i>
                                    <span class="circle"></span></a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="rpb-shop-prevw">
                    <img src="images/shop/item-perview.jpg" class="w-100" alt="img" />
                </div>
                        ...
                        <ul class="nav nav-tabs" id="myTab3" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="tab1a" data-bs-toggle="tab" href="#tab1" role="tab"
                                    aria-controls="tab1" aria-selected="true">Item Details</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="tab2b" data-bs-toggle="tab" href="#tab2" role="tab"
                                    aria-controls="tab2" aria-selected="false">Review</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="tab3c" data-bs-toggle="tab" href="#tab3" role="tab"
                                    aria-controls="tab3" aria-selected="false">Comments</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="tab4c" data-bs-toggle="tab" href="#tab4" role="tab"
                                    aria-controls="tab4" aria-selected="false">Support</a>
                            </li>
                        </ul>
                        <div class="tab-content" id="myTabContent2">
                            <div class="mt20 tab-pane fade show active" id="tab1" role="tabpanel"
                                ...
                                <h4 class="mb10">24-Hour Support:</h4>
                                <ul class="ul-list mb30">
                                    <li>Quick, Dedicated & Professional Support</li>
                                    <li>
                                        Please send us an email to
                                        <a href="https://separateweb.com/cdn-cgi/l/email-protection"
                                            class="__cf_email__"
                                            data-cfemail="cfbdaea5aabca7aba0a0bb8fa7a0bba2aea6a3e1aca0a2">[email&#160;protected]</a>
                                        with your details query. Thanks!
                                    </li>
                                </ul>

                                <h4 class="mb10">Template Features</h4>
                                <ul class="ul-list mb30">
                                ...
                                <div class="rpb-item-review">
                                    <div class="reviews-card">
                                        ...
                                        <div class="-client-details-">
                                            <div class="-reviewr">
                                                <img src="images/client/reviewer-c.jpg" alt="Good Review"
                                                    class="img-fluid" />
                                            </div>
                                            <div class="reviewer-text">
                                                ...
                                                <div class="star-rate">
                                                    <ul>
                                                        <li>
                                                            <a href="javascript:void(0)" class="chked"><i
                                ...
                                <div class="rpb-commentss comments-block">
                                    <div class="media">
                                        <div class="user-image">
                                            <img src="images/user-thumb/user3.jpg" alt="girl" class="img-fluid" />
                                        </div>
                                        <div class="media-body user-info">
                                            <h5 class="mb10">
                                                Petey Cruiser
                                                <small class="badges badge-success">PURCHASED:</small>
                                                <span>
                                                    November 29, 2019
                                    ...
                                    <div class="media replied">
                                        ...
                                        <div class="media-body user-info">
                                            <h5 class="mb10">
                                                Tom Mikee
                                                <small class="badges badge-success">Author:</small>
                                                <span>
                                                    November 29, 2019
                                                    <a class="reply-btn" href="#"><i class="fas fa-reply"></i></a>
                                                </span>
                                    ...
                                    <div class="form-block form-blog mt40">
                                        <form action="#" method="post" name="#">
                                            ...
                                            <div class="fieldsets mt10">
                                                <button type="submit" name="#" class="btn-main bg-btn3 lnk">
                                                    Post Comment
                            ...
                            <div class="tab-pane fade" id="tab4" role="tabpanel" aria-labelledby="tab4c">
                                <div class="rpb-itm-support-txt">
                                    <h4>Contact Us</h4>
                                    <p>
                                        Lorem Ipsum is simply dummy text of the printing and through
                                        email contact form.
                                    </p>
                                    ...
                                    <div class="btns">
                                        <a href="#" class="mt30 btn-main bg-btn3 lnk">Get Support <i
            ...
            <div class="col-lg-4">
                <div class="rpb-item-infodv">
                    <ul>
                        ...
                        <li>
                            <a href="#" class="btn-main bg-btn lnk w-100">Add to Cart <i
                                    class="fas fa-shopping-cart"></i>
                                <span class="circle"></span>
                            </a>
                            <a href="#" class="btn-main bg-btn3 lnk w-100 mt10">Buy Now <span class="circle"></span>
                            </a>
                        </li>
                    </ul>
                </div>
