      ...
      <div class="row">
        <div class="col-lg-6 v-center">
          <div class="header-heading">
            ...
            <a
              href="#"
              class="btn-main bg-btn3 lnk wow fadeInUp"
              data-wow-delay=".6s"
      ...
      <div class="col-lg-3 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".4s">
        <div class="s-block up-hor pt20">
          <div class="nn-card-set">
            <div class="card-icon">
              <img
                src="images/icons/mobile-rafiki.svg"
                alt="service"
                class="img-fluid"
              />
            </div>
      ...
      <div class="col-lg-3 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".6s">
        <div class="s-block up-hor pt20">
          <div class="nn-card-set">
            <div class="card-icon">
              <img
                src="images/icons/strategy-cuate.svg"
                alt="service"
                class="img-fluid"
              />
            </div>
      ...
      <div class="col-lg-3 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".8s">
        <div class="s-block up-hor pt20">
          <div class="nn-card-set">
            <div class="card-icon">
              <img
                src="images/icons/growth-ico.svg"
                alt="service"
                class="img-fluid"
              />
            </div>
...
<section class="about-dg-busign pb120 pt120 bg-light-ylo upset">
  <div class="up-curvs">
    <svg
      ...
      style="enable-background: new 0 0 1920 89.3"
      xml:space="preserve"
      fill="#e9f5ff"
    >
      <path
