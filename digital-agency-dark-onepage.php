      ...
      <div class="col-lg-5">
        <div class="hero-heading-sec">
          ...
          <a
            ...
            data-bs-target="#menu-popup"
            >Contact Us <i class="fas fa-chevron-right fa-ani"></i
            ><span class="circle"></span
          ></a>
  ...
  <div class="container">
    <div class="row upset">
      <div
        ...
        data-tilt-max="5"
        data-tilt-speed="1000"
        class="col-lg-6-cus wow fadeInUp"
        data-wow-delay=".2s"
      >
        <div class="service-sec-brp srvc-bg-nx bg-gradient13 text-w">
          ...
          <a href="javascript:void(0)" class="mt20 link-prb"
      ...
      <div
        ...
        data-tilt-max="5"
        data-tilt-speed="1000"
        class="col-lg-3-cus wow fadeInUp"
        data-wow-delay=".4s"
      >
      ...
      <div
        ...
        data-tilt-max="5"
        data-tilt-speed="1000"
        class="col-lg-3-cus mt30- wow fadeInUp"
        data-wow-delay=".8s"
      >
      ...
      <div
        ...
        data-tilt-max="5"
        data-tilt-speed="1000"
        class="col-lg-6-cus mt30- wow fadeInUp"
        data-wow-delay="1.2s"
      >
    ...
    <div class="-cta-btn mt70">
      <div class="free-cta-title v-center zoomInDown wow" data-wow-delay="1.4s">
        ...
        <a href="#" class="btn-main bg-btn2 lnk"
          >Hire Now<i class="fas fa-chevron-right fa-icon"></i
          ><span class="circle"></span
        ></a>
      </div>
    </div>
