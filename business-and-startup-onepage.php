            ...
            <div class="row">
                ...
                <div class="col-lg-6 v-center">
                    <div class="hero-photo">
                        <img src="images/hero/designer-girl-animate.svg" alt="img" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row upset">
            <div class="col-lg-3 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".2s">
                <div class="s-block up-hor pt20">
                    <div class="nn-card-set">
                        <div class="card-icon">
                            <img src="images/icons/designer.svg" alt="service" class="img-fluid" />
                        </div>
            ...
            <div class="col-lg-3 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".4s">
                <div class="s-block up-hor pt20">
                    <div class="nn-card-set">
                        <div class="card-icon">
                            <img src="images/icons/mobile-rafiki.svg" alt="service" class="img-fluid" />
                        </div>
            ...
            <div class="col-lg-3 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".6s">
                <div class="s-block up-hor pt20">
                    <div class="nn-card-set">
                        <div class="card-icon">
                            <img src="images/icons/strategy-cuate.svg" alt="service" class="img-fluid" />
                        </div>
            ...
            <div class="col-lg-3 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".8s">
                <div class="s-block up-hor pt20">
                    <div class="nn-card-set">
                        <div class="card-icon">
                            <img src="images/icons/growth-ico.svg" alt="service" class="img-fluid" />
                        </div>
...
<section class="about-dg-busign pb120 pt120 bg-light-ylo upset" id="about">
    <div class="up-curvs">
        <svg height="100" width="100%" version="1.1" xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1920 89.3"
            style="enable-background: new 0 0 1920 89.3" xml:space="preserve" fill="#e9f5ff">
            <path
...
c237.6,5.7,475.3,3.1,712.7-7.7c164.2-7.5,328.1-23.7,492.3-31c0.7,0,15.2-0.5,15.2-0.6C1919.5-0.5,1919.5,89.5,1919.5,89.5z" />
    ...
    <div class="bottom-curvs">
        <svg height="100" width="100%" version="1.1" xmlns="http://www.w3.org/2000/svg"
            ...
            style="enable-background: new 0 0 1920 89.3" xml:space="preserve" fill="#e9f5ff">
            <path
                d="M1919.5-0.5H-0.5c0,0,0,90,0,90c114.9-4.8,228.6-17.9,343.6-24.6c118.6-7,237.4-11.9,356.1-14.7
