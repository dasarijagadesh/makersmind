                ...
                <div class="col-lg-6 v-center">
                    <div class="header-heading">
                        <h1 class="wow fadeInUp" data-wow-delay=".2s">
                            We Analyze & Understand Your Buyers
                        </h1>
                        ...
                        <a href="#" class="btn-main bg-btn lnk wow fadeInUp" data-wow-delay=".6s">Get Strategy Call <i
                                class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
                    </div>
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay=".4s">
                    <div class="single-image">
                        <img src="images/hero/leads-hero.png" alt="hero image" class="img-fluid" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="common-heading text-l">
                    ...
                    <h2 class="mb20">
                        We Help Companies to Generate Leads and Increase Sales
                    </h2>
                    <p>
            ...
            <div class="col-lg-6 lead-intro-">
                <img src="images/about/lead-about.png" alt="image" class="img-fluid" />
            </div>
        </div>
    </div>
</section>
...
<section class="why-choos-lg pad-tb">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="single-image">
                    <img src="images/about/marketing-service.png" alt="hero image" class="img-fluid" />
                </div>
                <div class="cta-card mt60 text-center">
                    <h3>
                        Get your <span class="text-second text-bold">FREE</span> Digital
                        Audit
                    </h3>
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc
                    ...
                    <ul>
                        <li class="wow fadeIn" data-wow-delay=".2s">
                            <div class="clients-logo">
                                <img src="images/client/clients-1.png" alt="text" class="img-fluid" />
                            </div>
                        </li>
                        <li class="wow fadeIn" data-wow-delay=".4s">
                            <div class="clients-logo">
                                <img src="images/client/clients-2.png" alt="text" class="img-fluid" />
                            </div>
                        </li>
                        <li class="wow fadeIn" data-wow-delay=".6s">
                            <div class="clients-logo">
                                <img src="images/client/clients-3.png" alt="text" class="img-fluid" />
                            </div>
                        </li>
                        <li class="wow fadeIn" data-wow-delay=".8s">
                            <div class="clients-logo">
                                <img src="images/client/clients-4.png" alt="text" class="img-fluid" />
                            </div>
                        </li>
                        <li class="wow fadeIn" data-wow-delay="1s">
                            <div class="clients-logo">
                                <img src="images/client/clients-5.png" alt="text" class="img-fluid" />
                            </div>
                        </li>
                        <li class="wow fadeIn" data-wow-delay="1.2s">
                            <div class="clients-logo">
                                <img src="images/client/clients-7.png" alt="text" class="img-fluid" />
                            </div>
                        </li>
                        <li class="wow fadeIn" data-wow-delay="1.4s">
                            <div class="clients-logo">
                                <img src="images/client/clients-8.png" alt="text" class="img-fluid" />
                            </div>
                        </li>
                        <li class="wow fadeIn" data-wow-delay="1.6s">
                            <div class="clients-logo">
                                <img src="images/client/clients-9.png" alt="text" class="img-fluid" />
                            </div>
                        </li>
                        <li class="wow fadeIn" data-wow-delay="1.8s">
                            <div class="clients-logo">
                                <img src="images/client/clients-10.png" alt="text" class="img-fluid" />
                            </div>
                        </li>
                        <li class="wow fadeIn" data-wow-delay="2s">
                            <div class="clients-logo">
                                <img src="images/client/clients-11.png" alt="text" class="img-fluid" />
                            </div>
                        </li>
                    </ul>
                </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-sm-6 single-card-item wow fadeInUp" data-wow-delay=".2s">
                <div class="isotope_item hover-scale">
                    <div class="item-image">
                        <a href="#"><img src="images/blog/blog-1.jpg" alt="blog" class="img-fluid" />
                        </a>
                    ...
                    <div class="item-info blog-info">
                        ...
                        <h4>
                            <a href="#">Stock Market App Development - Time, Cost, Features</a>
                        </h4>
                        <p>
                            Lorem Ipsum is simply dummy text of the printing and typesetting
                            industry.
            ...
            <div class="col-lg-4 col-sm-6 single-card-item wow fadeInUp" data-wow-delay=".4s">
                <div class="isotope_item hover-scale">
                    <div class="item-image">
                        <a href="#"><img src="images/blog/blog-2.jpg" alt="blog" class="img-fluid" />
                        </a>
                        <span class="category-blog"><a href="#">iOs</a> <a href="#">Android</a></span>
                    </div>
                    <div class="item-info blog-info">
            ...
            <div class="col-lg-4 col-sm-6 single-card-item wow fadeInUp" data-wow-delay=".6s">
                <div class="isotope_item hover-scale">
                    <div class="item-image">
                        <a href="#"><img src="images/blog/blog-3.jpg" alt="blog" class="img-fluid" />
                        </a>
                    ...
                    <div class="item-info blog-info">
                        ...
                        <h4>
                            <a href="#">How to Increase Your ROI Through scientific SEM?</a>
                        </h4>
                        <p>
                            Lorem Ipsum is simply dummy text of the printing and typesetting
                            industry.
