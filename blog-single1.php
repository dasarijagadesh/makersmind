...
<section class="blog-page pb100">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="common-heading textalign-inherit">
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="image-set">
                    <img src="images/blog/blog-post-1.jpg" alt="blog images" class="img-fluid" />
                </div>
                <div class="blog-content mt30">
                    <p>
                        Lorem Ipsum is simply dummy text of the
                        <strong>printing and typesetting industry.</strong> Lorem Ipsum has
                    ...
                    <div class="image-set mt20 mb20">
                        <img src="images/blog/blog-post-2.jpg" alt="blog images" class="img-fluid" />
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="image-set mt20 mb20">
                                <img src="images/blog/blog-1.jpg" alt="blog images" class="img-fluid" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="image-set mt20 mb20">
                                <img src="images/blog/blog-2.jpg" alt="blog images" class="img-fluid" />
                            </div>
                        </div>
                    </div>
                    ...
                    <blockquote class="rd-quote">
                        “Nunc sed mattis diam. Suspendisse mi libero, sagittis nec varius
                        quis, pulvinar eu nisl. Nulla in accumsan orci, a varius velit.
                        Maecenas tincidunt mauris rutrum, eleifend sem at, sollicitudin
                        ante.”
                    </blockquote>
                    ...
                    <!-- <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 mt30 mb30">
                            <div class="post-navigation text-left text-md-right">
                                ...
                                <h4>
                                    <a href="#">How digital transformation has changed the world.</a>
                                </h4>
                            </div>
                        </div>
                    </div> -->
                ...
                <div class="comments-block mt60">
                    <h3 class="mb60 clr-or">Comments:</h3>
                    <div class="media">
                        <div class="user-image">
                    ...
                    <div class="form-block form-blog mt60">
                        <form action="#" method="post" name="#">
                            ...
                            <div class="fieldsets mt10">
                                <button type="submit" name="#" class="btn-main bg-btn lnk">
                                    Submit <i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span>
                                </button>
                            </div>
                        </form>
            ...
            <div class="col-lg-4">
                <div class="sidebar">
                    ...
                    <div class="recent-post widgets mt60">
                        <h3 class="mb30 clr-or">Recent post</h3>
                        <div class="media">
                            ...
                            <div class="media-body post-info">
                                <h5>
                                    <a href="#" class="clr-w">Stock Market App Development - Time, Cost, Features</a>
                                </h5>
