...
<div>
    <svg preserveAspectRatio="none" viewBox="0 0 1200 120" xmlns="http://www.w3.org/2000/svg"
        style="fill:#20242c; width: 100%; height: 160px; transform: rotate(180deg);"
...
<footer class="footerdez footerdex dark-footer">
    ...
    <div class="container padding-footer-con">
            ...
            <div class="col-lg-12 col-sm-12">
                ...
                <div class="row fttlnks">
                    ...
                    <div class="col-lg-2 col-sm-6 ">
                        ...
                        <ul class="footer-address-list link-hover">
                            <li><a href="get-quote.html">Product Designing
                                </a></li>
                    ...
                    <div class="col-lg-2 col-sm-6 ">
                        ...
                        <ul class="footer-address-list link-hover">
                            <li><a href="get-quote.html">Domain
                                </a></li>
                ...
                <div class="row fttlnks flexend">
                    <div class="col-lg-3 col-sm-12 pt-2">
                        <div class="footerdez-a">
                            <div class="">
                                <img src="images/mm-logo.png" alt="Logo" class="img-fluid" />
                            </div>
                            <p class="mt10">
                                Do.No 2-152/2, Opposite Toyota Showroom Rayudupalem Junction, kakinada, Andhra Pradesh,
                                533005
                            </p>
