                ...
                <div class="col-lg-7">
                    <div class="header-headings">
                        ...
                        <h1 class="wow fadeIn mt20 mb30" data-wow-delay=".4s">
                            Creative Design Company We Create
                            <span class="typer" id="main" data-words="Websites, Apps, Graphics, Brandings, Marketings"
                                data-delay="100" data-deleteDelay="1000"></span>
                            <span class="cursorx" data-owner="first-typer">|</span>
                        </h1>
                ...
                <div class="col-lg-5 v-center">
                    <div class="form-block formcover shadow">
                        ...
                        <form id="contactForm" data-bs-toggle="validator" class="shake mt30">
                            ...
                            <button type="submit" id="form-submit" class="btn btn-main bg-btn3">
                                Submit
                            </button>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="img-design h-scl-">
                    <div class="imgac">
                        <img src="images/hero/creative-ag2a.jpg" alt="creative agnecy html template"
                            class="ag-dg1 img-fluid h-scl-base" />
                    </div>
                    <div class="imgac h-scl-base">
                        <img src="images/hero/creative-ag2b.jpg" alt="creative agnecy html template"
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p>
                                ...
                                aliquet ligula nec leo elementum semper. Mauris aliquet egestas
                                metus.
                            </p>
                        </div>
                    </div>
            ...
            <div class="col-lg-12">
                <div class="whychooseniwax v-center">
                    ...
                    <div class="niwaxawardrow2">
                        <h2>
                            Why Should You
                            <span class="text-radius text-light text-animation bg-b">Choose Us!</span>
                        </h2>
                ...
                <div class="niwax-review-slider owl-carousel center-dots">
                    <div class="reviews-card pr-shadow">
                        <div class="row v-center">
                            ...
                            <div class="col">
                                <span class="revbx-rl"><img src="images/client/upwork-logo.png"
                                        alt="review service logo" /></span>
                            </div>
                        </div>
