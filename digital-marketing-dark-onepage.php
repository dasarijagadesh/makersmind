...
<!--End Header -->
<!--Start Hero-->
<section class="hero-section hero-bg-bg1 bg-gradient1 digi-mkt" id="home">
      ...
      <div class="row">
        <div class="col-lg-6 v-center">
          <div class="header-heading">
            <h1 class="wow fadeInUp" data-wow-delay=".2s">
              <span class="xhighlight">Result Based</span> Digital Marketing
            </h1>
            ...
            <a
              ...
              data-wow-delay=".6s"
              >Get A Free Quote <i class="fas fa-chevron-right fa-icon"></i
              ><span class="circle"></span
            ></a>
          </div>
        </div>
        <div class="col-lg-6 v-center">
          <div class="single-image wow fadeIn" data-wow-delay=".5s">
            <img
              src="images/hero/digital-marketing.png"
              alt="hero image"
              class="img-fluid"
            />
          </div>
    ...
    <div class="row">
      <div class="col-lg-6 v-center">
        <div class="image-block">
          <img
            src="images/about/about-service.png"
            alt="about"
      ...
      <div class="col-lg-6">
        <div class="common-heading text-l">
          ...
          <a href="#contact" class="btn-main bg-btn lnk mt30"
            >Contact Us <i class="fas fa-chevron-right fa-icon"></i
            ><span class="circle"></span
          ></a>
        </div>
      </div>
      ...
      >
        <div class="office-card">
          ...
          <div class="office-text">
            ...
            <a href="javascript:void(0)" target="blank" class="btn-outline"
              >View on Map <i class="fas fa-chevron-right fa-icon"></i
            ></a>
          </div>
        </div>
      </div>
