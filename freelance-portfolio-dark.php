...
<!--End Header -->
<!--Start Hero-->
<section class="hero-section fl-hero">
  <div class="text-block">
    <div class="container">
      <div class="row">
        <div class="col-lg-6 v-center">
          <div class="header-heading">
            <span class="title- wow fadeInUp" data-wow-delay=".1s"
              >Hi there, I am Deo Jones</span
            >
            <h1 class="wow fadeInUp" data-wow-delay=".2s">
              <span>Freelance</span> Web Designer
            </h1>
            ...
            <a
              ...
              data-wow-delay=".6s"
              >Hire Me <i class="fas fa-chevron-right fa-icon"></i
        ...
        <div class="col-lg-6 wow fadeIn" data-wow-delay=".4s">
          <div class="single-image">
            <img
              src="images/hero/freelancer-mobile.png"
              alt="service"
              class="img-fluid"
            />
          </div>
...
<!--End Clients-->
<!--Start Testinomial-->
<section class="testinomial-section pad-tb dim-dark">
  <div class="container">
    <div class="row">
    ...
    <div class="row">
      ...
      <div class="col-lg-6 v-center">
        <div class="enquire-image">
          <img
            src="images/about/freelancer.png"
            alt="enquire"
            class="img-fluid"
          />
        </div>
