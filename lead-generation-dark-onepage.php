      ...
      <div class="modal-content">
        <div class="modal-header">
          <div class="common-heading">
            <h4 class="mt0 mb0">Get Strategy Call</h4>
          </div>
      ...
      <div class="row">
        <div class="col-lg-6 v-center">
          <div class="header-heading">
            ...
            <a
              ...
              >Get Strategy Call <i class="fas fa-chevron-right fa-icon"></i
              ><span class="circle"></span
            ></a>
          </div>
        </div>
        <div class="col-lg-6 wow fadeIn" data-wow-delay=".4s">
          <div class="single-image">
            <img
              src="images/hero/leads-hero.png"
              alt="hero image"
              class="img-fluid"
            />
          </div>
    ...
    <div class="-cta-btn mt70">
      <div class="free-cta-title v-center wow zoomInDown" data-wow-delay="1s">
        ...
        <a href="#" class="btn-main bg-btn2 lnk">
          Free Quote<i class="fas fa-chevron-right fa-icon"></i
          ><span class="circle"></span
        ></a>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6">
        <div class="single-image">
          <img
            src="images/about/marketing-service.png"
            alt="hero image"
            class="img-fluid"
          />
        </div>
        ...
        <div class="isotope_item hover-scale">
          ...
          <div class="item-info blog-info">
            <div class="entry-blog">
              ...
              <span
                ><a href="#"><i class="fas fa-comment-dots"></i> (23)</a></span
              >
            </div>
            <h4>
              <a href="#"
