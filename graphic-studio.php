      ...
      <div class="row">
        <div class="col-lg-6 v-center">
          <div class="header-heading">
            <h1 class="wow fadeInUp text-effect-1" data-wow-delay=".2s">
        ...
        <div class="col-lg-6 v-center tilt-3d">
          <div
            class="img-with-shape base"
            data-tilt
            data-tilt-max="8"
            data-tilt-speed="2000"
          >
            <div class="shape-dg-1 dg-hero-shp2">
              <img
                src="images/shape/shape-dg-1.png"
                alt="shape"
            ...
            <img
              src="images/about/digi-agency-dg.jpg"
              alt="digital agency"
              class="img-fluid dg-hero-img0"
            />
            <div class="shape-dg-1 dg-hero-shp1a">
              <img
            ...
            <div class="shape-dg-1 dg-hero-shp3">
              <img
                src="images/shape/shape-dg-2.png"
                alt="shape"
                class="img-fluid niwax"
                data-rellax-speed="4"
              />
...
<section class="about-dg- dg-bg--2 pb130 pt130">
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6 v-center tilt-3d">
        <div
          class="img-block base pl--100"
          data-tilt
          data-tilt-max="4"
          data-tilt-speed="2000"
        >
          <img
            src="images/about/digital-agency-dg.jpg"
            alt="about"
...
<section class="about-dg-2 dg-bg--1 pb130 pt130">
  <div class="container">
    <div class="row">
      <div class="col-lg-6 v-center tilt-3d">
        <div
          class="img-block base pr--100 m-mb30 mt0"
          data-tilt
          data-tilt-max="4"
          data-tilt-speed="2000"
        >
          <img
            src="images/about/about-dg-agency.jpg"
            alt="about"
            class="img-fluid upset dg-hero-img0"
          />
          <div class="shape-dg-1 dg-hero-shp1a">
      ...
      <div class="col-lg-6">
        <div class="common-heading-2 text-l">
          ...
          <a href="#" class="btn-main bg-btn4 lnk mt40"
            >Request a proposal<i class="fas fa-chevron-right fa-icon"></i
            ><span class="circle"></span
          ></a>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-sm-6">
        <div class="statistics">
          <div
            ...
            data-tilt-max="20"
            data-tilt-speed="1000"
            class="statistics-img dg-bg2"
          >
            <img
              src="images/icons/startup-w.svg"
              alt="years"
              class="img-fluid"
            />
          </div>
    ...
    <div class="row small t-ctr">
      ...
      <div class="col-lg-3 col-sm-6">
        <div class="statistics">
          ...
          >
            <img
              src="images/icons/computers-w.svg"
              alt="project"
              class="img-fluid"
            />
          </div>
      ...
      <div class="col-lg-3 col-sm-6">
        <div class="statistics mb0">
          ...
          >
            <img
              src="images/icons/customer-service-w.svg"
              alt="support"
              class="img-fluid"
            />
          </div>
        ...
        <div class="single-blog-post- up-hor">
          <div class="single-blog-img-">
            ...
            <div class="entry-blog-post dg-bg2">
              <span class="bypost-"
                ><a href="#"><i class="fas fa-tag"></i> Nodejs</a></span
              >
      ...
      <div class="col-lg-4 mt30">
        <div class="single-blog-post- up-hor">
          <div class="single-blog-img-">
            ...
            <div class="entry-blog-post dg-bg2">
              <span class="bypost-"
                ><a href="#"><i class="fas fa-tag"></i> Laravel</a></span
              >
              <span class="posted-on-">
          ...
          <div class="blog-content-tt">
            <div class="single-blog-info-">
              <h4>
                <a href="#"
                  >Exploring the Key Features of Laravel 7 Framework</a
                >
              </h4>
              <p>
                Lorem Ipsum is simply dummy text of the printing and typesetting
        ...
        <div class="single-blog-post- up-hor">
          <div class="single-blog-img-">
            ...
            <div class="entry-blog-post dg-bg2">
              <span class="bypost-"
                ><a href="#"
                  ><i class="fas fa-tag"></i> Mobile Application</a
                ></span
              >
              <span class="posted-on-">
          ...
          <div class="blog-content-tt">
            <div class="single-blog-info-">
              <h4>
                <a href="#"
                  >Best Technology for Mobile Application Development</a
                >
              </h4>
              <p>
                Lorem Ipsum is simply dummy text of the printing and typesetting
