            ...
            <div class="col-lg-7">
                <div class="bread-titlev2">
                    ...
                    <p class="mt20 wow fadeInUp" data-wow-delay=".4s">
                        Use the search box below to get started. Your dream site awaits!
                    </p>
                    <div class="email-subs-form mt60">
                        <form>
                            <input type="text" placeholder="Search..." name="search-shop" class="no-shadow" />
                            <button type="submit" name="submit" class="lnk btn-main bg-btn no-shadow">
                                Search <i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span>
                            </button>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-lg-8">
                ...
                <div class="shop-cat-title">
                    <ul class="shop-tags-list mt60">
                        <li>
                            <a href="#" class="active">agency<span>(13)</span></a>
                        </li>
                        <li>
                            <a href="#">business<span>(12)</span></a>
                        </li>
                        <li>
                            <a href="#">cafe<span>(32)</span></a>
                        </li>
                        <li>
                            <a href="#">cargo<span>(12)</span></a>
                        </li>
                        <li>
                            <a href="#">clinic<span>(23)</span> </a>
                        </li>
                        <li>
                            <a href="#">construction<span>(34)</span></a>
                        </li>
                        <li>
                            <a href="#">consulting<span>(43)</span></a>
                        </li>
                        <li>
                            <a href="#">corporate<span>(03)</span></a>
                        </li>
                        <li>
                            <a href="#">consultant<span>(06)</span></a>
                        </li>
                        <li>
                            <a href="#">corporate<span>(02)</span></a>
                        </li>
                        <li>
                            <a href="#">COVID-19<span>(06)</span></a>
                        </li>
                        <li>
                            <a href="#">creative<span>(16)</span></a>
                        </li>
                        <li>
                            <a href="#">dental<span>(20)</span></a>
                        </li>
                        <li>
                            <a href="#">dentist<span>(45)</span></a>
                        </li>
                        <li>
                            <a href="#">digital agency<span>(2)</span></a>
                        </li>
                        <li>
                            <a href="#">doctor<span>(30)</span></a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="rpb-shop-items-dv s-block mt60">
                    ...
                    <div class="rpb-shop-items-info">
                        <div class="rpb-shop-items-tittl">
                            <h3>
                                <a href="#">Niwax - Creative Agency & Portfolio HTML Template</a>
                            </h3>
