    ...
    <div class="row">
      <div class="col-lg-6 v-center">
        <div class="hero-heading-sec2 niwax" data-rellax-speed="3">
          ...
          <div
            class="content-sec d-flex mt30 v-center text-w wow fadeIn"
            data-wow-delay="0.6s"
          >
            <div class="mr25">
      ...
      <div class="col-lg-6 v-center">
        <div class="app-hero-bnr wow fadeIn" data-wow-delay="0.4s">
          <img
            src="images/hero/mobile_hero_banner.png"
            alt="niwax mobile app development company"
            class="img-fluid"
          />
        </div>
          ...
          <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-12 col-6">
              <div class="funfct srcl1">
                ...
                />
                <span class="services-cuntr counter">20</span
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-6">
              <div class="funfct srcl2">
                <img
                  ...
                  alt="niwax app development template"
                />
                <span class="services-cuntr counter">250</span
                ><span class="services-cuntr">+</span>
                <p>Talented Squad</p>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12 col-6">
              <div class="funfct srcl3">
                <img
                  ...
                  alt="niwax app development template"
                />
                <span class="services-cuntr counter">1200</span
                ><span class="services-cuntr">+</span>
                <p>Apps Developed</p>
              </div>
            </div>
    ...
    <div class="row upset">
      <div class="col-lg-4 col-md-6 mt30 wow fadeIn" data-wow-delay="0.2s">
        <div class="service-card-app hoshd">
          ...
          <a href="javascript:void(0)" class="mt20 link-prbs"
            >Read More <i class="fas fa fa-arrow-circle-right"></i
          ></a>
        </div>
      </div>
          ...
          <div class="tec-icon mt30">
            <ul class="servc-icon-sldr">
              <li>
                <a href="#"
                  ><div class="img-iconbb">
                    <img src="images/icons/ux.svg" alt="img" /></div
                ></a>
              </li>
              <li>
                <a href="#"
                  ><div class="img-iconbb">
                    <img src="images/icons/php.svg" alt="img" /></div
                ></a>
              </li>
              <li>
                <a href="#"
                  ><div class="img-iconbb">
                    <img src="images/icons/java.svg" alt="img" /></div
                ></a>
              </li>
              <li>
                <a href="#"
                  ><div class="img-iconbb">
                    <img src="images/icons/wordpress.svg" alt="img" /></div
                ></a>
              </li>
            </ul>
          </div>
          ...
          <div class="tec-icon mt30">
            <ul class="servc-icon-sldr">
              <li>
                <a href="#"
                  ><div class="img-iconbb">
                    <img src="images/icons/magento.svg" alt="img" /></div
                ></a>
              </li>
              <li>
                <a href="#"
                  ><div class="img-iconbb">
                    <img src="images/icons/shopify.svg" alt="img" /></div
                ></a>
              </li>
              <li>
                <a href="#"
                  ><div class="img-iconbb">
                    <img src="images/icons/woocommerce.svg" alt="img" /></div
                ></a>
              </li>
            </ul>
          </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        ...
        <div class="cta-card mt60 text-center">
          ...
          <a href="#" class="btn-outline lnk mt30"
            >Request A Quote <i class="fas fa-chevron-right fa-icon"></i
            ><span class="circle"></span
          ></a>
        </div>
      ...
      <div class="col-lg-4 col-sm-6 mt40 wow fadeIn" data-wow-delay="0.8s">
        <div class="isotope_item up-hor">
          <div class="item-image">
            <a href="#"
              ><img
                src="images/portfolio/app-img4.jpg"
                alt="image"
                class="img-fluid"
              />
            </a>
      ...
      <div class="col-lg-4 col-sm-6 mt40 wow fadeIn" data-wow-delay="1s">
        <div class="isotope_item up-hor">
          <div class="item-image">
            <a href="#"
              ><img
                src="images/portfolio/app-img5.jpg"
                alt="image"
                class="img-fluid"
              />
            </a>
      ...
      <div class="col-lg-4 col-sm-6 mt40 wow fadeIn" data-wow-delay="1.2s">
        <div class="isotope_item up-hor">
          <div class="item-image">
            <a href="#"
              ><img
                src="images/portfolio/app-img6.jpg"
                alt="image"
                class="img-fluid"
              />
            </a>
      ...
      <div class="col-lg-12">
        <div class="client-logoset">
          <ul class="row text-center clearfix apppg">
            <li
              class="col-lg-2 col-md-3 col-sm-4 col-6 mt30 wow fadeIn"
              data-wow-delay=".2s"
            >
      ...
      <div class="col-lg-5">
        ...
        <div class="row mt30 justify-content-center">
          <a
            href="#"
            target="blank"
            class="wow fadeIn col-lg-4 col-4"
            data-wow-delay=".2s"
            ><img
        ...
        <div class="office-card hoshd">
          ...
          <div class="info-text-div">
            ...
            <ul class="-address-list mt10">
              <li>
                <a
                  href="https://separateweb.com/cdn-cgi/l/email-protection#e68f888089a68493958f8883959588878b83c885898b"
                  ><i class="fas fa-envelope"></i>
                  <span
                    class="__cf_email__"
                    data-cfemail="325b5c545d725047415b5c5741415c535f571c515d5f"
              ...
              <li>
                <a href="tel:+10000000000"
                  ><i class="fas fa-phone-alt"></i> +1 0000 000 000</a
                >
              </li>
            </ul>
          </div>
        ...
        <div class="office-card hoshd">
          ...
          <div class="info-text-div">
            ...
            <ul class="-address-list mt10">
              <li>
                <a
                  href="https://separateweb.com/cdn-cgi/l/email-protection#b0d9ded6dff0d2c5c3d9ded5c3c3ded1ddd59ed3dfdd"
                  ><i class="fas fa-envelope"></i>
                  <span
                    class="__cf_email__"
                    data-cfemail="3851565e57785a4d4b51565d4b4b5659555d165b5755"
                    >[email&#160;protected]</span
                  ></a
                >
              </li>
        ...
        <div class="office-card hoshd">
          ...
          <div class="info-text-div">
            ...
            <ul class="-address-list mt10">
              <li>
                <a
                  href="https://separateweb.com/cdn-cgi/l/email-protection#157c7b737a557760667c7b7066667b7478703b767a78"
                  ><i class="fas fa-envelope"></i>
                  <span
                    class="__cf_email__"
                    data-cfemail="2c45424a436c4e595f4542495f5f424d4149024f4341"
                    >[email&#160;protected]</span
                  ></a
                >
              </li>
